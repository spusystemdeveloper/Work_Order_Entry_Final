...
Public Class ErrorLogger
    ...
    Public Shared Function LogError(ByVal ex As Exception, Optional ByVal context As String = "") As String
        ...
        Try
            ...
            ' Safe retrieval of user, register, and environment
            Dim username As String = SafeGetUsername()
            Dim register As String = SafeGetRegister()
    ...
    Private Shared Function SafeGetUsername() As String
        Try
            If Not String.IsNullOrWhiteSpace(frmItemLookUp.usrUsername) Then
                Return frmItemLookUp.usrUsername.Trim()
            End If
        Catch
        End Try
    ...
    Private Shared Function SafeGetRegister() As String
        Try
            If Not String.IsNullOrWhiteSpace(frmItemLookUp.usrRegister) Then
                Return frmItemLookUp.usrRegister.Trim()
            End If
            If Not String.IsNullOrWhiteSpace(sReg) Then
                Return sReg.Trim()
            End If
        Catch
        End Try
