...
DECLARE @ExistingType char(2) =
    (SELECT type FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[QueueingItems]'));

IF @ExistingType IS NOT NULL AND @ExistingType <> 'U '
    THROW 52000, 'Object type conflict for [dbo].[QueueingItems].', 1;
...
CREATE TABLE [dbo].[QueueingItems](
	...
	[ItemID] [int] NULL,
	[QtyPre] [int] NULL,
	[Picker] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Status] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[PickLoc] [varchar](max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
