...
DECLARE @ExistingType char(2) =
    (SELECT type FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SOD_Reg]'));

IF @ExistingType IS NOT NULL AND @ExistingType <> 'U '
    THROW 52000, 'Object type conflict for [dbo].[SOD_Reg].', 1;
...
CREATE TABLE [dbo].[SOD_Reg](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[ipadd] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[regid] [int] NULL,
 CONSTRAINT [PK_SOD_Reg] PRIMARY KEY CLUSTERED 
(
	[id] ASC
