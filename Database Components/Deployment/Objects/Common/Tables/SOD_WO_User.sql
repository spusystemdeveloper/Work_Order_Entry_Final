...
DECLARE @ExistingType char(2) =
    (SELECT type FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SOD_WO_User]'));

IF @ExistingType IS NOT NULL AND @ExistingType <> 'U '
    THROW 52000, 'Object type conflict for [dbo].[SOD_WO_User].', 1;
...
CREATE TABLE [dbo].[SOD_WO_User](
	[UserID] [int] IDENTITY(1000,1) NOT NULL,
	[UserFullName] [varchar](max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[UserName] [varchar](max) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[UserPass] [varchar](max) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[UserRegister] [int] NULL,
 CONSTRAINT [PK_SOD_WO_User] PRIMARY KEY CLUSTERED 
(
	[UserID] ASC
