...
CREATE TABLE [dbo].[SOD_WO_Conf](
	...
	[Pass2Username] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[Pass3Username] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
 CONSTRAINT [PK_SOD_WO_Conf_1] PRIMARY KEY CLUSTERED 
(
	[id] ASC
